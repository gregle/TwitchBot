...
Timers.prototype.checkStatus = function(){
	Twitch.isStreamOnline(function(status){
		Logger.log("Stream Status Check: " + status);
...
Timers.prototype.setAudienceTimer = function(){
	...
	Logger.log("Started " + Config.audience.updateRate + " minute update Audience timer");
};
...
Timers.prototype.setCurrencyTimer = function(){
	...
	Logger.log("Started " + timer/60/1000 + " minute update Currency timer");
};
